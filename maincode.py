...
def main():
	...
	st.markdown(" New Users: Create an account by clicking the SignUp option from the dropdown menu on the left side of your screen Login to your account by clicking on the Login option from the dropdown menu At this point, you should be able to see the data that your doctor has added to your account.The next time you go to your doctor’s office, make sure to sign in to Pocket HealthRef on their computer so that your doctor can update your information")
