...
def main():
    ...
    if choice == "Home":
        st.subheader("Home")
        st.text( "Pocket HealthRef is a web-based tool where you can access information about your recent \n visits to the doctor’s office! Among other things, Patient HealthRef allows you to relisten to your visit with your doctor. If you’ve ever felt like you forgot some important information after a visit, Pocket HealthRef is just the tool for you! ")
